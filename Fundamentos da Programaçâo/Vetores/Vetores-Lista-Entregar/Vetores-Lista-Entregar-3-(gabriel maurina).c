...
int main(void)
{
    char vetorGabarito[10], vetorResposta[10], opcRepetir; 
    ...
    do
    {
        ...
        for (i = 0; i < 10; i++)
        {
            do
            {
                ...
                if(vetorGabarito[i] < 'A' || vetorGabarito[i] > 'E' && vetorGabarito[i] < 'a' || vetorGabarito[i] > 'e')
                    {
        ...
        for (j = 1; j <= contAluno; j++)
        {
            ...
            for (i = 0; i < 10; i++)
            {
                do
                {
                    ...
                    if(vetorResposta[i] < 'A' || vetorResposta[i] > 'E' && vetorResposta[i] < 'a' || vetorResposta[i] > 'e')
                    {
                        printf("Caracter errado");
                    }
